...
const buttonVariants = cva(
  'leading-[1.2] inline-flex items-center justify-center whitespace-nowrap rounded-[100px] text-[0.8rem] font-normal ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
