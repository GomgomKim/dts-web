...
export const DownloadDropdown = (props: DownloadDropdownProps) => {
  ...
  const imageRatio: AspectRatio = 'ASPECT_RATIO_9_16'
  const exportQualityOption = EXPORT_QUALITY_OPTIONS_9_16
  ...
  return (
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <Button
          className="flex rounded-[.5rem] py-2 pl-3 pr-4"
      ...
      <DropdownMenuContent className="w-[400px]" sideOffset={10}>
        {/* menu 1 */}
